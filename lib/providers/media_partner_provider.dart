...
class MediaPartnerProvider with ChangeNotifier {
  ...
  List<MediaPartnerModel> favoriteMediaPartners(String eventId) {
    return _mediaPartners.where((mediaPartner) => mediaPartner.eventId == eventId && mediaPartner.isFavorite == true).toList();
  }
}
